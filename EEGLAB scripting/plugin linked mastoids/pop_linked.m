% % pop_linked() - Gratton ocular correction. Apply the function to
...
%
% Usage:
%   >>  OUTEEG = pop_linked( INEEG, new_mast, 'key', 'value',...);
%
% Inputs:
...
function [EEG, com] = pop_linked( EEG, new_mast, varargin );
...
% le righe seguenti servono per rimuovere A2 perch non ha pi senso
EEG.data=EEGreresh;
EEG.data=EEGtemp([[1:1:new_mast-1] [new_mast+1:1:EEG.nbchan]],:);
EEG.nbchan = EEG.nbchan-1; 
%dico che c' un canale in meno

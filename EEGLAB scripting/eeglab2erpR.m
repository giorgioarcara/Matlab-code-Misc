...
%
%
% Authors: Giorgio Arcara, 2016. Update: 2020 ver 0.2
...
for i=1:size(conditions,2);
    ...
    for k=1:size(conditions{i},2);
        mergedname=strcat(mergedname, num2str(conditions{i}{k}));
    end;

%% STEP 1 NOPOSA (ONLY SOME ADJUSTMENTS TO TWO RECORDINGS SEE FILE SELECTION)
...
my_sFiles = sel_files_bst({my_sFiles_ini.FileName}, '.');
my_sFiles = sel_files_bst({my_sFiles_ini.FileName}, 'NP802_ISRProse_20170420_01|NP812_ISRRestingEC_20171102_01|NP812_ISRRestingEO_20171102_01');
...
% Input files
epoched_files_bad=sel_files_bst(my_sFiles, 'ASSR|MMN|Prose');
...
Subj_files = sel_files_bst(my_sFiles, 'Prose|Resting');

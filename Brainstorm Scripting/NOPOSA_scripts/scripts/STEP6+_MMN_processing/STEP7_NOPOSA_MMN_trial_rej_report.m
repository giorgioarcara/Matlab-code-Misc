...
Report_tag = '_MMN_trials';
mkdir([export_main_folder, '/' trial_rej_folder]) % 
...
for iSubj=1:length(SubjectNames);
        ...
        newReportName = [SubjectNames{iSubj}, Report_tag, '.mat'];
        Report_path = bst_fileparts(ReportFile);
        copyfile(ReportFile, [Report_path, '/', newReportName]);
        
        %bst_report('Open', ReportFile);
        bst_report('Export', [Report_path, '/', newReportName], [export_main_folder, trial_rej_folder]);

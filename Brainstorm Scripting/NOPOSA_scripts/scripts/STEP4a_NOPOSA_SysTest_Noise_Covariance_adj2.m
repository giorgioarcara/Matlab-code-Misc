...
% NP807 has a noise with very bad channels (I selected only a segment
% withhout strange behaviour)
% NP810 have a noise with a jump in the first seconds (skipped)
%
...
Noise_File = {...
    'NP807/@rawNP807_SysTest_20171025_01_clean_resample/data_0raw_NP807_SysTest_20171025_01_clean_resample.mat'};


Res = bst_process('CallProcess', 'process_noisecov', Noise_File, [], ...
    'baseline',       [8,100], ... %% NOTE!! I set thse seconds to avoid some jumpts
    'datatimewindow', [,], ...
    'sensortypes',    'MEG', ...
...
Noise1_path = 'NP807/@rawNP807_SysTest_20171025_01_clean_resample/';

function varargout = process_evt_sequence( varargin )
...
function sProcess = GetDescription() %#ok<DEFNU>
    ...
    sProcess.Comment     = 'Combine two events';
    ...
    sProcess.options.combine.Comment = ['Example: We have one stim (A) and two responses (B and C).<BR>' ...
                                        ...
                                        'You may add as many combinations as needed, one per line.<BR><BR><BR>'...
                                        '<B>GIORGIO: Lascia ignore come primo argomento!!! </B> <BR>'...
                                        'funzione temporanea <BR><BR><BR>' ];
    sProcess.options.combine.Type    = 'textarea';
    sProcess.options.combine.Value   = ['ignore, B_AB , A , B' 10 'ignore, C_AC , A , C'];

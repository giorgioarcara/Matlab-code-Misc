function varargout = process_corr1n_g( varargin )
...
% MOD: GIORGIO ARCARA; line 151, and line 87 point to bst_connectivity_g
eval(macro_method);
end
...
function sProcess = GetDescription() %#ok<DEFNU>
    ...
    sProcess.Comment     = 'Envelope Correlation NxN';
...
function OutputFiles = Run(sProcess, sInputA) %#ok<DEFNU>
    ...
    % Compute metric
    OutputFiles = bst_connectivity_g({sInputA.FileName}, [], OPTIONS);
end

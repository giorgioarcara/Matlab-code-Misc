    ...
    for iCond=1:length(Conditions)
        ...
        for irun=1:length(runs)
            ...
            Res = bst_process('CallProcess', 'process_hilbert', link_files, [], ...
                'clusters',  {'Destrieux', {'G_temporal_middle R', 'G_temporal_middle L', 'G_front_middle L', 'G_front_middle R', 'G_pariet_inf-Angular L', 'G_pariet_inf-Angular R', 'G_pariet_inf-Supramar L', 'G_pariet_inf-Supramar R', 'G_parietal_sup L', 'G_parietal_sup R', 'S_intrapariet_and_P_trans L', 'S_intrapariet_and_P_trans R'}}, ...
                'scoutfunc', 1, ...  % Mean
                'edit',      struct(...

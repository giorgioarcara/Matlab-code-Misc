%% GTbrainplot(GTres, nodefield, edgefield, labelfields, Coords, n_cols, node_multi, brainpath, cmap)
%
...
function GTbrainplot(GTres, nodefield, edgefield, labelfields, Coords, n_cols, node_multi, brainpath, cmap)
